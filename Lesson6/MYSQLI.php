<?php
 ...
 $sql_stmt_KH = "CREATE table KHACHHANG(
...
$sql_stmt_NV = "CREATE table NHANVIEN(
...
$sql_stmt_SP = "CREATE table SANPHAM(
...
$sql_stmt_HD = "CREATE table HOADON(
...
$sql_stmt_CTHD = "CREATE table CTHD(
...
$result = mysqli_query($dbh, $sql_stmt_KH); // Thực thi câu lệnh SQL
...
$result = mysqli_query($dbh, $sql_stmt_NV); // Thực thi câu lệnh SQL
...
$result = mysqli_query($dbh, $sql_stmt_SP); // Thực thi câu lệnh SQL
...
$result = mysqli_query($dbh, $sql_stmt_HD); // Thực thi câu lệnh SQL
...
$result = mysqli_query($dbh, $sql_stmt_CTHD); // Thực thi câu lệnh SQL
...
$sql_stmt_KH = "INSERT INTO khachhang (MAKH,HOTEN,DIACHI,SODT,NGAYSINH,DOANHSO,NGDK)
...
$sql_stmt_NV = "INSERT INTO nhanvien (MANV,HOTEN,NGVL,SODT)
...
$sql_stmt_SP = "INSERT INTO sanpham (MASP,TENSP,DVT,NUOCSX,GIA)
...
$sql_stmt_HD = "INSERT INTO hoadon (SOHD,NGHD,MAKH,MANV,TRIGIA)
...
// UPDATE DATA
$sql_stmt = "UPDATE khachhang set HOTEN = 'NguyenThuHa222' where MAKH = 'KH01'";
...
//delete
$sql_stmt = "DELETE from khachhang where MAKH = 'KH10'";
